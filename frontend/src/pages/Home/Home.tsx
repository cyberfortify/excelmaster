    ...
    return (
      <main className="bg-white dark:bg-[#0b0f0d]">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto flex min-h-[88vh] max-w-7xl flex-col items-center gap-16 px-6 py-20 lg:flex-row">
            {/* LEFT */}
            <motion.div
              ...
              className="flex-1"
            >
              <h1 className=" text-5xl font-black leading-[1.05] tracking-tight text-gray-900 lg:text-7xl dark:text-white">
                Master Excel
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Link
                  to="/learn"
                  className="group flex items-center gap-2 rounded-xl bg-[#1e8449] px-7 py-4 font-semibold text-white shadow-lg shadow-emerald-900/20 transition hover:bg-[#166638]"
                >
                  Start Learning Free
                ...
                <Link
                  to="/learn"
                  className="rounded-xl border border-gray-300 bg-white px-7 py-4 font-semibold text-gray-800 transition hover:border-[#1e8449] hover:text-[#1e8449] dark:border-white/10 dark:bg-white/5 dark:text-white"
                >
                  Browse Topics
                </Link>
              </div>
                ...
                {["No signup required", "300+ lessons", "Real datasets"].map(
                  (item) => (
                    <span key={item} className="flex items-center gap-1.5">
                      <Check size={16} className="text-[#1e8449]" />
                      {item}
                    </span>
                  )
                )}
              ...
              <div className="mt-16 grid grid-cols-3 gap-8 border-t border-gray-100 pt-8 dark:border-white/10">
                {[
                  ["300+", "Excel Topics"],
                  ...
                  <div key={label}>
                    <h2 className="text-3xl font-bold text-[#1e8449] lg:text-4xl">
                      {num}
                    </h2>
                      ...
                      {cellData.map((row, ri) => (
                        ...
                        >
                          {row.map((cell, ci) => (
                            <td
                              key={ci}
                              className={`border border-gray-100 px-4 py-3 dark:border-white/5 ${ri === 0
